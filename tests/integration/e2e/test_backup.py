...
def test_point_in_time_recovery(juju: jubilant.Juju, s3_bucket: Bucket, kafka, zookeeper):
...
def test_new_cluster_migration(juju: jubilant.Juju, s3_bucket: Bucket, kafka, zookeeper):
