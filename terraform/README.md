<!-- BEGIN_TF_DOCS -->
This repository contains the Kubernetes charm Terraform bundle for the Charmed Apache Kafka, available on [Charmhub](https://charmhub.io/kafka-k8s).

The Charmed Apache Kafka K8s Terraform bundle can be used to deploy Apache Kafka brokers and KRaft controllers, Kafka Connect, Karapace Schema Registry, and Kafbat Kafka UI on Kubernetes with minimal configuration overhead.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_broker"></a> [broker](#module\_broker) | git::https://github.com/canonical/kafka-k8s-operator//terraform | main |
| <a name="module_connect"></a> [connect](#module\_connect) | git::https://github.com/canonical/kafka-connect-k8s-operator//terraform | main |
| <a name="module_controller"></a> [controller](#module\_controller) | git::https://github.com/canonical/kafka-k8s-operator//terraform | main |
| <a name="module_karapace"></a> [karapace](#module\_karapace) | git::https://github.com/canonical/karapace-k8s-operator//terraform | main |
| <a name="module_ui"></a> [ui](#module\_ui) | git::https://github.com/canonical/kafka-ui-k8s-operator//terraform | main |
...
| [juju_integration.kafka_ui_ingress](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/integration) | resource |
...
| [juju_integration.otel_cos_dashboard](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/integration) | resource |
| [juju_integration.otel_cos_logging](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/integration) | resource |
| [juju_integration.otel_cos_metrics](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/integration) | resource |
...
| <a name="input_ingress_offer"></a> [ingress\_offer](#input\_ingress\_offer) | Ingress provider endpoint to be used on for the Kafka UI. | `string` | `null` | no |
...
| <a name="input_model_uuid"></a> [model\_uuid](#input\_model\_uuid) | The Juju Model UUID to deploy to | `string` | n/a | yes |
