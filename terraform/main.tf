...
module "broker" {
  source      = "git::https://github.com/canonical/kafka-k8s-operator//terraform?ref=feat/terraform"
  model       = var.model
...
module "connect" {
  ...
  source      = "git::https://github.com/canonical/kafka-connect-k8s-operator//terraform?ref=feat/terraform"
  model       = var.model
...
module "karapace" {
  ...
  source      = "git::https://github.com/canonical/karapace-k8s-operator//terraform?ref=feat/terraform"
  model       = var.model
...
module "ui" {
  ...
  source      = "git::https://github.com/canonical/kafka-ui-k8s-operator//terraform?ref=feat/terraform"
  model       = var.model
